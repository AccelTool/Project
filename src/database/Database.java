...
public class Database {
    ...
    public void createDB() {
        String entree = "CREATE TABLE ENTREES (\"ID\" int GENERATED BY DEFAULT AS IDENTITY, \"Case\" int, He float, Hs float, Te float, Diam_WR float, WRyoung int, \"offset ini\" int, mu_ini float, Force float, G float, PRIMARY KEY (\"ID\"))";
        String sortie = "CREATE TABLE SORTIES (\"ID\" int NOT NULL, \"Case\" int, Errors varchar(255), OffsetYield float, Friction float, Rolling_Torque float, Sigma_Moy float, Sigma_Ini float, Sigma_Out float, Sigma_Max float, Force_Error float, Slip_Error float, Has_Converged varchar(255) NOT NULL, PRIMARY KEY (\"ID\"))";
        try {
