...
public class Database {
    ...
    public void createDB() {
        String entree = "CREATE TABLE ENTREES (\"ID\" int GENERATED BY DEFAULT AS IDENTITY, \"Case\" int, He float, Hs float, Te float, Ts float, Diam_WR float, WRyoung int, \"offset ini\" int, mu_ini float, Force float, G float, PRIMARY KEY (\"ID\"))";
